from models.dl.lstm_gru_hybrid_original import LSTM_GRU
from util import plot_training, save_results, dataset_binance_original, r2
        ...
        for c in cryptos:
            for rep in range(1, 4):
                ...
                for index, r in enumerate(retrain):
                    ...
                    ds = dataset_binance_original.BinanceDataset(filename=f'crypto_task_{c}.csv', 
                                                                 input_window=window, 
                                                                 output_window=1,
                                                                 horizon=h, 
