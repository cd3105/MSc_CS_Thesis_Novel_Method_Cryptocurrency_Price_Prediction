...
for n in normalized:
    ...
    for m in models:
        ...
        for c in cryptos:
            if n:
                current_average_metric_results_base_path = f"Original_Code/new_res/{m}/Average_Metrics/Normalized/"
                average_metrics_file_name = f"average_metrics_{m}-{c}-close-w30-h0-12m_N"
            else:
                current_average_metric_results_base_path = f"Original_Code/new_res/{m}/Average_Metrics/Regular/"
    ...
    model_average_results_path = f'Original_Code/new_res/_Average_Results/'
