...
for c in cryptos:
    for m in models:
        for n in normalized:
            ...
            if n:
                current_base_metric_results_path = f"Original_Code/new_res/{m}/Metrics/Normalized/"
                save_path = f"Original_Code/new_res/{m}/Average_Metrics/Normalized/"
                average_metrics_file_name = f"average_metrics_{m}-{c}-close-w30-h0-12m_N"
                suffix = "_N"
            else:
                current_base_metric_results_path = f"Original_Code/new_res/{m}/Metrics/Regular/"
                save_path = f"Original_Code/new_res/{m}/Average_Metrics/Regular/"
