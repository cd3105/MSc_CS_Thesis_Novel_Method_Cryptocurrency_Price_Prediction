...
class ModelInterface:
    def __init__(self, name):
        ...
        self.model_path = 'Original_Code/saved_models/'
    ...
    def predict(self, X):
        ...
        if self.model is None:
            ...
            return
        X = X.reshape(-1, 1) # Reset Input Variable Set for Model Input
        predictions = self.model.predict(X) # Perform Predictions using Input Variables
        return predictions # Return Predictions produced by Model
    ...
    def training(self, p, X_test):
        ...
        self.create_model() # Call function for Model Creation
        train_model = self.fit() # Fit Model to Training Data
