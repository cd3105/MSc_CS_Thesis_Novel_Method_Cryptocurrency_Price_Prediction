...
Ks = list(range(2, 16))
alpha_vals = list(range(250, 10001, 250))
    ...
    for cc in os.listdir(current_price_data_base_path):
        ...
        for f in os.listdir(f"{current_price_data_base_path}{cc}"):
            ...
            if f == '1_Day': 
                ...
                if f == '1_Day':
                    current_results_df.to_csv(f"{current_results_path}VMD_1_Reconstruction_Accuracy_{cc}_Daily_Close_Price.csv")
