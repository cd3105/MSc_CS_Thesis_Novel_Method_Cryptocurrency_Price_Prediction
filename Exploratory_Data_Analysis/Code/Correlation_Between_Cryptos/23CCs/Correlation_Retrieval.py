...
price_types = {'Opening_Price': opening_price_df[(opening_price_df['TIMESTAMP'] >= datetime(2017, 6, 1)) & (opening_price_df['TIMESTAMP'] < datetime(2025, 1, 1))].drop('TIMESTAMP', 
               ...
               'Closing_Price': closing_price_df[(closing_price_df['TIMESTAMP'] >= datetime(2017, 6, 1)) & (closing_price_df['TIMESTAMP'] <= datetime(2025, 1, 1))].drop('TIMESTAMP', 
                                                                                                                                                                         axis=1).reset_index(drop=True),}
base_save_path_pc = "Exploratory_Data_Analysis/Results/Correlation_Between_Cryptos/23CCs/Retrieved_Correlation/Pearson_Correlation/"
base_save_path_sc = "Exploratory_Data_Analysis/Results/Correlation_Between_Cryptos/23CCs/Retrieved_Correlation/Spearman_Correlation/"
base_save_path_gct = "Exploratory_Data_Analysis/Results/Correlation_Between_Cryptos/23CCs/Retrieved_Correlation/Granger_Causality/"
all_pcs = []
all_scs = []
all_gcts = {'BTC': [],
            'ETH': [],
