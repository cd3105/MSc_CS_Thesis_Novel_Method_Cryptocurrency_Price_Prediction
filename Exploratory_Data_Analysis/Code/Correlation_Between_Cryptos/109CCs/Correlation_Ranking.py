...
correlation_base_path = "Exploratory_Data_Analysis/Results/Correlation_Between_Cryptos/109CCs/Retrieved_Correlation/"
    ...
    if corr == 'Granger_Causality':
        for cc in selected_cryptos:
            ...
            for csv in os.listdir(f"{correlation_base_path}{corr}/{cc}/"):
                ...
                current_ranked_corr_fp = f"Exploratory_Data_Analysis/Results/Correlation_Between_Cryptos/109CCs/Ranked_Correlation/{corr}/{cc}/{csv[4:-4]}/"
        ...
        for csv in os.listdir(f"{correlation_base_path}{corr}/"):
            ...
            for cc in selected_cryptos:
                ...
                current_ranked_corr_fp = f"Exploratory_Data_Analysis/Results/Correlation_Between_Cryptos/109CCs/Ranked_Correlation/{corr}/{cc}/"
