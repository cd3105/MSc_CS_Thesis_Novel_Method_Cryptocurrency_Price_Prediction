...
correlation_base_path = "Exploratory_Data_Analysis/Results/Correlation_Between_Cryptos/YF_CCs/Retrieved_Correlation/"
    ...
    if corr == 'Granger_Causality':
        for cc in selected_cryptos:
            ...
            for csv in os.listdir(f"{correlation_base_path}{corr}/{cc}/"):
                ...
                current_ranked_corr_fp = f"Exploratory_Data_Analysis/Results/Correlation_Between_Cryptos/YF_CCs/Ranked_Correlation/{corr}/{cc}/{csv[4:-4]}/"
        ...
        for csv in os.listdir(f"{correlation_base_path}{corr}/"):
            ...
            for cc in selected_cryptos:
                ...
                if cc in current_corr_df.columns: 
                    current_ranked_corr_df = current_corr_df[[cc]].sort_values(cc, 
                                                                            ascending=False).iloc[1:]
                    current_ranked_corr_fp = f"Exploratory_Data_Analysis/Results/Correlation_Between_Cryptos/YF_CCs/Ranked_Correlation/{corr}/{cc}/"
