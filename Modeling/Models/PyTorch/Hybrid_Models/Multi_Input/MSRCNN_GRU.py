...
class MI_MSRCNN_GRU(nn.Module):
    def __init__(self, 
                 dataset,):
        super(MI_MSRCNN_GRU, self).__init__()
...
class HPT_MI_MSRCNN_GRU(nn.Module):
    def __init__(self, 
                 dataset,
                 ...
                 dense_dims=[],
                 dense_activations=[]):
        super(HPT_MI_MSRCNN_GRU, self).__init__()
